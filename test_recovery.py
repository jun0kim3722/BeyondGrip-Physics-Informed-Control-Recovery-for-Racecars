...
class SlipParamGenerator:
    ...
    def generate(self):
        ...
        return {
            ...
            # I HAVE MADE TESTING EASIER THAN TRAINING.
            # in the training the counter duration std is 6 so it is much harder to recovery many times impossible.
